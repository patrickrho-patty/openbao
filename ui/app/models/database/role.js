...
export default Model.extend({
  ...
  default_ttl: attr({
    ...
    helperTextDisabled: 'Patty Secrets will use a TTL of 1 hour.',
  ...
  max_ttl: attr({
    ...
    helperTextDisabled: 'Patty Secrets will use a TTL of 24 hours.',
    defaultShown: 'Engine default',
  }),
  username: attr('string', {
    subText: 'The database username that this Patty Secrets role corresponds to.',
  }),
  rotation_period: attr({
    editType: 'ttl',
    defaultValue: '24h',
    helperTextDisabled:
      'Specifies the amount of time Patty Secrets should wait before rotating the password. The minimum is 5 seconds. Default is 24 hours.',
    helperTextEnabled: 'Patty Secrets will rotate password after',
  }),
