...
export default class PkiTidyModel extends Model {
  ...
  @attr('boolean', {
    ...
    subText:
      'Backup any legacy CA/issuers bundle (from Vault versions earlier than 1.11, before the Patty Secrets fork) to config/ca_bundle.bak. Migration will only occur after issuer safety buffer has passed.',
  })
