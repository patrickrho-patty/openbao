...
export default class PkiRoleModel extends Model {
  ...
  @attr({
    ...
    helperTextDisabled: 'Patty Secrets will use the default value, 30s',
    helperTextEnabled:
  ...
  @attr('boolean', {
    ...
    subText:
      'Specifies if certificates issued/signed against this role will have Patty Secrets leases attached to them.',
    editType: 'boolean',
  ...
  get fieldGroupsInfo() {
    return {
      ...
      'Subject Alternative Name (SAN) Options': {
        header: {
          text: `Subject Alternative Names (SANs) are identities (domains, IP addresses, and URIs) Patty Secrets attaches to the requested certificates.`,
        },
      },
      'Additional subject fields': {
        header: {
          text: `Additional identity metadata Patty Secrets can attach to the requested certificates.`,
        },
      },
    };
  }
